#ifndef DECONVGAUSHFDUNE35T_H
#define DECONVGAUSHFDUNE35T_H

////////////////////////////////////////////////////////////////////////
//
// DeconvGausHFDUNE35t class
//
// jti3@fnal.gov
//
...
namespace deconvgaushf {
  ...
  class DeconvGausHFDUNE35t : public art::EDProducer {

  public:
    
    // create calibrated signals on wires. this class runs 
    // an fft to remove the electronics shaping.     
    explicit DeconvGausHFDUNE35t(fhicl::ParameterSet const& pset); 
  ...
  //-------------------------------------------------
  DeconvGausHFDUNE35t::~DeconvGausHFDUNE35t()
  {
  }

  //////////////////////////////////////////////////////
  void DeconvGausHFDUNE35t::reconfigure(fhicl::ParameterSet const& p)
  {
  ...
  //-------------------------------------------------
  void DeconvGausHFDUNE35t::beginJob()
  {  
    collectioncount = 0;
    inductioncount = 0;
  ...
  //////////////////////////////////////////////////////
  void DeconvGausHFDUNE35t::endJob()
  {  
  }
  
  //////////////////////////////////////////////////////
  void DeconvGausHFDUNE35t::produce(art::Event& evt)
  {      
    // get the geometry
	...
	for(bin=0; bin < (unsigned int)fPostsample; ++bin) 
      ...
      //if(wirecol->size() == 0)
      //mf::LogWarning("DeconvGausHFDUNE35t") << "No wires made for this event.";
	  ...
	  while( hitIndex < (signed)startTimes.size() ) {
		...
		sprintf(outputfilename,"/dune/data/users/jti3/fits/induction_deconvgaus_fit_%d.eps",inductioncount);
		...
		sprintf(outputfilename,"/dune/data/users/jti3/fits/collection_deconvgaus_fit_%d.eps",collectioncount);
		TCanvas *c1 = new TCanvas("c1","plot");
		c1->SetFillColor(0);
		gStyle->SetOptFit(1);
		hitSignal.Draw();
