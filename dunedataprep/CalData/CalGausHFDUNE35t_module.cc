#ifndef CALGAUSHFDUNE35T_H
#define CALGAUSHFDUNE35T_H

////////////////////////////////////////////////////////////////////////
//
// CalGausHFDUNE35t class
//
// jti3@fnal.gov
//
...
namespace calgaushf {
  ...
  class CalGausHFDUNE35t : public art::EDProducer {

  public:
    
    // create calibrated signals on wires. this class runs 
    // an fft to remove the electronics shaping.     
    explicit CalGausHFDUNE35t(fhicl::ParameterSet const& pset); 
  ...
  }; // class CalGausHFDUNE35t

  DEFINE_ART_MODULE(CalGausHFDUNE35t)
  ...
  //-------------------------------------------------
  CalGausHFDUNE35t::~CalGausHFDUNE35t()
  {
  }

  //////////////////////////////////////////////////////
  void CalGausHFDUNE35t::reconfigure(fhicl::ParameterSet const& p)
  {
  ...
  //-------------------------------------------------
  void CalGausHFDUNE35t::beginJob()
  { 
    collectioncount = 0;
    inductioncount = 0;
  ...
  //////////////////////////////////////////////////////
  void CalGausHFDUNE35t::endJob()
  {  
  }
  
//   //////////////////////////////////////////////////////
//   double CalGausHFDUNE35t::expfitf(double *x,double *par)
//   {
//     double arg1 = 0;
//     double arg2 = 0;
...
//   }
  ...
  //////////////////////////////////////////////////////
  void CalGausHFDUNE35t::produce(art::Event& evt)
  {      
    ...
    mf::LogInfo("CalGausHFDUNE35t") << "CalGausHFDUNE35t:: digitVecHandle size is " << digitVecHandle->size();
	...
	for(int i=0; i<numberofblocks; i++){
	  ...
	  RMS = 0;         						// stores the RMS of the gaussian shape of the hit
...
// 		sprintf(outputfilename,"/dune/data/users/jti3/fits/induction_calgaus_fit_%d.eps",inductioncount);
...
// 		sprintf(outputfilename,"/dune/data/users/jti3/fits/collection_calgaus_fit_%d.eps",collectioncount);
// 		TCanvas *c1 = new TCanvas("c1","plot");
// 		c1->SetFillColor(0);
// 		gStyle->SetOptFit(1);
// 		hitSignal.Draw();
