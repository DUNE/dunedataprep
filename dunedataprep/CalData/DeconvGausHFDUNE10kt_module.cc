#ifndef DECONVGAUSHFDUNE10KT_H
#define DECONVGAUSHFDUNE10KT_H

////////////////////////////////////////////////////////////////////////
//
// DeconvGausHFDUNE10kt class
//
// jti3@fnal.gov
//
...
namespace deconvgaushf {
  ...
  class DeconvGausHFDUNE10kt : public art::EDProducer {

  public:
    
    // create calibrated signals on wires. this class runs 
    // an fft to remove the electronics shaping.     
    explicit DeconvGausHFDUNE10kt(fhicl::ParameterSet const& pset); 
  ...
  //-------------------------------------------------
  DeconvGausHFDUNE10kt::~DeconvGausHFDUNE10kt()
  {
  }

  //////////////////////////////////////////////////////
  void DeconvGausHFDUNE10kt::reconfigure(fhicl::ParameterSet const& p)
  {
  ...
  //-------------------------------------------------
  void DeconvGausHFDUNE10kt::beginJob()
  {  
  }

  //////////////////////////////////////////////////////
  void DeconvGausHFDUNE10kt::endJob()
  {  
  }
